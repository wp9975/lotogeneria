...
const MiniLottoInteractiveNumberBoard = ({
  excludedNumbers,
  setExcludedNumbers,
  requiredNumbers,
  setRequiredNumbers,
  ...
  return (
    <div className="grid grid-cols-5 gap-2 bg-gray-200 rounded-xl p-7 md:grid-cols-10 interactive-number-board">
      {numbers.map((number) => (
        <button
          key={number}
...
export default MiniLottoInteractiveNumberBoard;
